...
const desc = [
  "Preparing a national competition during 2 years in order to join an engineering school in France. I studied Mathematics and Physics, \n \
then passed the entrance exams for a Grande Ecole",

  "Studying in a general engineering school ENSMM in Besançon (France), majoring in embedded systems and object-oriented programming \n \
  ...
  "Studying 1 more year in order to get a double master's degree in Machine Learning and Data Science. This joint Specialized Master® is co-accredited by INP-ENSEEIHT\n \
and INSA Toulouse. It is focused on the processing and valuation of massive data, favoring a multidisciplinary approach in computer science and data sciences and \n \
combining scientific and operational learning through project-based learning and strong involvement of partner companies.",

  "First internship in Paris Louis Vuitton's head office as a developper. I created programming tools for the mechanical engineering department : \n \
  ...
  "Second internship as a mechanical designer in a design office. I also helped develop programs and tools on machining tools for metallurgy industry : \n \
- Part of the pre-project team, drawing up offers to answer to a call for tender : proposing solutions, illustrated with designs/concepts (CAD). \n \
- Working in relation with various french and international industrials (such as Dassault, Ariane, AD&S) \n \
- Working in 'Project Mode' : Taking advantage of my applied mathematics skills in specific cases (models, 3D transformations, solving systems, ...) \n \
...
\
Getting involved in Innolab's technological watch around AI subjects by sharing knowledge of new Frameworks, languages, etc. within the team",
];
